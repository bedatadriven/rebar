...
import com.bedatadriven.gears.persistence.client.domain.Person;
import com.bedatadriven.gears.persistence.client.domain.PersonUnit;
import com.bedatadriven.gears.persistence.server.BulkOperationBuilder;
...
public class PersonTest extends PersistenceUnitTestCase {
  ...
  @Test
  public void testBulk() throws JSONException, SQLException, BulkException {
    ...
    MockBulkOperationExecutor etor = new MockBulkOperationExecutor(connectionProvider.getConnection());
