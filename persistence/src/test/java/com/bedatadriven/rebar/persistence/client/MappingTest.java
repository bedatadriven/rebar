...
import com.bedatadriven.rebar.persistence.mapping.*;
...
public class MappingTest {
  ...
  public void testAssumptions() {
    ...
    Assert.assertEquals("java.lang.String", new JreTypeInfo(String.class).getQualifiedName());
    Assert.assertEquals("String", new JreTypeInfo(String.class).getSimpleName());
    Assert.assertEquals("int", new JreTypeInfo(Integer.TYPE).getSimpleName());
  }
