 ...
 * @author Alex Bertram
 */
class GearsResultSet extends AbstractResultSet {

  private GearsStatement statement;
  ...
  GearsResultSet(GearsStatement statement, com.google.gwt.gears.client.database.ResultSet rs) {
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    return new SqliteResultSetMetadata(rs);
  }
